...
Unlike fragile Jupyter Notebooks, this pipeline treats data and models as **Assets**, allowing for:
...
| :--- | :--- | :--- |
| **Full Run** | 58s | Loads data, cleans, trains all models. |
| **Partial Run** | **19s** | Skips loading/cleaning. Only retrains models. |
| **Efficiency** | **~67%** | Time saved per iteration. |

##  How to Run
1. Install dependencies: `pip install dagster pandas scikit-learn`
2. Run the pipeline UI: `dagster dev -f pipeline.py`
3. Click **"Materialize All"** to execute.
